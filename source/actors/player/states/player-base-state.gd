...
#
#	if Input.is_action_just_pressed("action_boost") and owner.can_boost:
#		owner.change_state("BoostingState")
#		return true
#	elif Input.is_action_just_pressed("action_boost") and not owner.can_boost:
#		timer.start()
#
#	if Input.is_action_pressed("action_boost") and not timer.is_stopped() and owner.can_boost:
#		owner.change_state("BoostingState")
#		timer.stop()
#		return true
#
